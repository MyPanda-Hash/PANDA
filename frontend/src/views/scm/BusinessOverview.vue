...
const modules = [
  {
    ...
    edges: [
      ...
      { from: 'MANU_ORDER', to: 'PU_REQ' },
    ],
    pos: {
      SO_ORDER: [20, 40], MANU_ORDER: [230, 40], PROCESS_REPORT: [440, 40],
      MATERIAL_REQ: [440, 130], MATERIAL_OUT: [650, 130],
      FINISH_IN: [440, 220], PU_REQ: [440, 310],
    },
    docs: [
      { code: 'MANU_ORDER', label: '生产加工单' }, { code: 'PROCESS_REPORT', label: '工序汇报单' },
      { code: 'MATERIAL_REQ', label: '领料申请单' }, { code: 'MATERIAL_OUT', label: '材料出库单' },
      { code: 'FINISH_IN', label: '产成品入库单' }, { code: 'SO_ORDER', label: '销售订单' },
  ...
  },
  {
    ...
    pos: {
      PU_REQ: [30, 170], PU_ORDER: [260, 170], PURCHASE_IN: [490, 140], PU_IN: [490, 260],
    },
    docs: [
      { code: 'PU_REQ', label: '请购单' }, { code: 'PU_ORDER', label: '采购订单' },
